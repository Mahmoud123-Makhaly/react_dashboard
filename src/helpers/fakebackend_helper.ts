...
import * as samples from '@assets/data/velzon/index';
...
// Ecommerce
// get Products
export const getProducts = () => Promise.resolve(samples.productsData);
...
// get Orders
export const getOrders = () => Promise.resolve(samples.orders);
...
// get Customers
export const getCustomers = () => Promise.resolve(samples.customerList);
...
// get Sellers
export const getSellers = () => Promise.resolve(samples.sellersList);
...
// Tasks
// get Task
export const getTaskList = () => Promise.resolve(samples.tasks);
...
// CRM
// get Contacts
export const getContacts = () => Promise.resolve(samples.crmcontacts);
...
// Order List
export const getOrderList = () => Promise.resolve(samples.orders);
...
export const getAllData = () => Promise.resolve(samples.allData);
export const getHalfYearlyData = () => Promise.resolve(samples.halfyearData);
export const getMonthlyData = () => Promise.resolve(samples.monthData);

// Audiences Metrics
export const getAllAudiencesMetricsData = () => Promise.resolve(samples.allaudiencesMetricsData);
export const getMonthlyAudiencesMetricsData = () => Promise.resolve(samples.monthaudiencesMetricsData);
export const getHalfYearlyAudiencesMetricsData = () => Promise.resolve(samples.halfyearaudiencesMetricsData);
export const getYearlyAudiencesMetricsData = () => Promise.resolve(samples.yaeraudiencesMetricsData);

// Users by Device
export const getTodayDeviceData = () => Promise.resolve(samples.todayDeviceData);
export const getLastWeekDeviceData = () => Promise.resolve(samples.lastWeekDeviceData);
export const getLastMonthDeviceData = () => Promise.resolve(samples.lastMonthDeviceData);
export const getCurrentYearDeviceData = () => Promise.resolve(samples.currentYearDeviceData);

// Audiences Sessions by Country
export const getTodaySessionData = () => Promise.resolve(samples.todayaudiencesCountryData);
export const getLastWeekSessionData = () => Promise.resolve(samples.lastWeekaudiencesCountryData);
export const getLastMonthSessionData = () => Promise.resolve(samples.lastMonthaudiencesCountryData);
export const getCurrentYearSessionData = () => Promise.resolve(samples.currentyearaudiencesCountryData);

// Dashboard CRM

// Balance Overview
export const getTodayBalanceData = () => Promise.resolve(samples.todayBalanceData);
export const getLastWeekBalanceData = () => Promise.resolve(samples.lastWeekBalanceData);
export const getLastMonthBalanceData = () => Promise.resolve(samples.lastMonthBalanceData);
export const getCurrentYearBalanceData = () => Promise.resolve(samples.currentYearBalanceData);

// Dial Type
export const getTodayDealData = () => Promise.resolve(samples.todayDealData);
export const getWeeklyDealData = () => Promise.resolve(samples.weeklyDealData);
export const getMonthlyDealData = () => Promise.resolve(samples.monthlyDealData);
export const getYearlyDealData = () => Promise.resolve(samples.yealyDealData);

// Sales Forecast
export const getOctSalesData = () => Promise.resolve(samples.octData);
export const getNovSalesData = () => Promise.resolve(samples.novData);
export const getDecSalesData = () => Promise.resolve(samples.decData);
export const getJanSalesData = () => Promise.resolve(samples.janData);

// Dashboard Ecommerce
// Revenue
export const getAllRevenueData = () => Promise.resolve(samples.allRevenueData);
export const getMonthRevenueData = () => Promise.resolve(samples.monthRevenueData);
export const getHalfYearRevenueData = () => Promise.resolve(samples.halfYearRevenueData);
export const getYearRevenueData = () => Promise.resolve(samples.yearRevenueData);
