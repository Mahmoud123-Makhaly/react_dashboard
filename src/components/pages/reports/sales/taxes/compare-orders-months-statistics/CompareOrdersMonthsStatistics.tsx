...
const CompareOrdersMonthsStatistics = ({ dataType = 'Sales' }: { dataType?: 'Sales' | 'Count' }) => {
  ...
  const t = useTranslate('COMP_TaxCompareOrdersMonthsStatistics');
  ...
  const loadData = useCallback(async () => {
    ...
    apiClient
      .select<IDistributedColumnChartSeries>(`${endpoints.reports.sales.taxes.monthlyStatistics}${dataType}`)
      .then(
        data => {
