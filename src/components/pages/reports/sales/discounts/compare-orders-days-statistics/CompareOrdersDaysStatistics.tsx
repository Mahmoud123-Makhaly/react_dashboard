...
const CompareOrdersDaysStatistics = () => {
  ...
  const t = useTranslate('COMP_ReportSalesDiscountCompareOrdersDaysStatistics');
  ...
  const loadData = useCallback(async () => {
    ...
    apiClient
      .select<IDistributedColumnChartSeries>(
        `${endpoints.reports.sales.discounts.dailyStatistics}${filterCriteriaValues.dataType}`,
        {
