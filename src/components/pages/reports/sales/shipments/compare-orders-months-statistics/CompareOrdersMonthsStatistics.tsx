...
const CompareOrdersMonthsStatistics = ({ dataType = 'Sales' }: { dataType?: 'Sales' | 'Count' }) => {
  ...
  const t = useTranslate('COMP_ShipmentCompareOrdersMonthsStatistics');
  ...
  const loadData = useCallback(async () => {
    ...
    apiClient
      .select<IDistributedColumnChartSeries>(`${endpoints.reports.sales.shipments.monthlyStatistics}${dataType}`)
      .then(
        data => {
