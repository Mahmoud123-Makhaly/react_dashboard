...
//import Images
import img01 from '@assets/img/sidebar/img-1.jpg';
import img02 from '@assets/img/sidebar/img-2.jpg';
import img03 from '@assets/img/sidebar/img-3.jpg';
import img04 from '@assets/img/sidebar/img-4.jpg';
...
const RightSidebar = () => {
  ...
  function tog_show() {
    setShow(!show);
    dispatch(changeSidebarTheme('gradient') as unknown as AnyAction);
  }
  ...
  useEffect(() => {
    if (
      ...
      document.getElementById('sidebar-color-dark')!.attributes['checked'] = false;
      document.getElementById('sidebar-color-light')!.attributes['checked'] = false;
    }
  });
                  ...
                  <div className="col-4">
                    <div className="form-check card-radio">
                      <input
                        ...
                        onChange={e => {
                          if (e.target.checked) {
                            dispatch(changeLayout(e.target.value) as unknown as AnyAction);
                          }
                        }}
                    ...
                    <div className="col-4">
                      <div className="form-check card-radio">
                        <input
                          ...
                          onChange={e => {
                            if (e.target.checked) {
                              dispatch(changeLayoutMode(e.target.value) as unknown as AnyAction);
                            }
                          }}
                        />
                      ...
                      <div className="col-4">
                        <div className="form-check card-radio">
                          <input
                            ...
                            onChange={e => {
                              if (e.target.checked) {
                                dispatch(changeSidebarVisibility(e.target.value) as unknown as AnyAction);
                              }
                            }}
                          />
                          ...
                          <div className="col-4">
                            <div className="form-check card-radio">
                              <input
                                ...
                                onChange={e => {
                                  if (e.target.checked) {
                                    dispatch(changeLayoutWidth(e.target.value) as unknown as AnyAction);
                                    dispatch(changeLeftsidebarSizeType('lg') as unknown as AnyAction);
                                  }
                                }}
                              />
                            ...
                            <div className="form-check card-radio">
                              <input
                                ...
                                onChange={e => {
                                  if (e.target.checked) {
                                    dispatch(changeLayoutWidth(e.target.value) as unknown as AnyAction);
                                    dispatch(changeLeftsidebarSizeType('sm-hover') as unknown as AnyAction);
                                  }
                                }}
                              />
                    ...
                    <div id="layout-position">
                      ...
                      <div className="btn-group radio" role="group">
                        <input
                          ...
                          onChange={e => {
                            if (e.target.checked) {
                              dispatch(changeLayoutPosition(e.target.value) as unknown as AnyAction);
                            }
                          }}
                        />
                  ...
                  <div className="col-4">
                    <div className="form-check card-radio">
                      <input
                        ...
                        onChange={e => {
                          if (e.target.checked) {
                            dispatch(changeTopbarTheme(e.target.value) as unknown as AnyAction);
                          }
                        }}
                      />
                        ...
                        <div className="col-4">
                          <div className="form-check sidebar-setting card-radio">
                            <input
                              ...
                              onChange={e => {
                                if (e.target.checked) {
                                  dispatch(changeLeftsidebarSizeType(e.target.value) as unknown as AnyAction);
                                }
                              }}
                            />
                          ...
                          <div className="col-4">
                            <div className="form-check sidebar-setting card-radio">
                              <input
                                ...
                                onChange={e => {
                                  if (e.target.checked) {
                                    dispatch(changeLeftsidebarViewType(e.target.value) as unknown as AnyAction);
                                  }
                                }}
                              />
                          ...
                          <div className="form-check sidebar-setting card-radio">
                            <input
                              ...
                              onChange={e => {
                                setShow(false);
                                if (e.target.checked) {
                                  dispatch(changeSidebarTheme(e.target.value) as unknown as AnyAction);
                                }
                              }}
                            />
                      ...
                      <div className="d-flex gap-2 flex-wrap img-switch">
                        <div className="form-check sidebar-setting card-radio">
                          <input
                            ...
                            onChange={e => {
                              if (e.target.checked) {
                                dispatch(changeSidebarImageType(e.target.value) as unknown as AnyAction);
                              }
                            }}
                          />
                    ...
                    <div className="col-4">
                      <div className="form-check sidebar-setting card-radio">
                        <input
                          ...
                          onChange={e => {
                            if (e.target.checked) {
                              dispatch(changePreLoader(e.target.value) as unknown as AnyAction);
                            }
                          }}
                        />
