...
//import images
import image1 from '@assets/img/products/img-1.png';
import image2 from '@assets/img/products/img-2.png';
import image3 from '@assets/img/products/img-3.png';
import image6 from '@assets/img/products/img-6.png';
import image5 from '@assets/img/products/img-5.png';
        ...
        <SimpleBar style={{ maxHeight: '300px' }}>
          <div className="p-2">
            <div className="text-center empty-cart" id="empty-cart" style={{ display: 'none' }}>
              ...
              <Link href="/apps-ecommerce-products" className="btn btn-success w-md mb-3">
                Shop Now
              </Link>
            </div>
            ...
            {cartData.map((item, key) => (
              <div className="d-block dropdown-item text-wrap dropdown-item-cart px-3 py-2" key={key}>
                <div className="d-flex align-items-center">
                  <Image src={item.img} className="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic" />
                  <div className="flex-1">
                    <h6 className="mt-0 mb-1 fs-14">
                      <Link href="/apps-ecommerce-product-details" className="text-reset">
                        {item.product}
                      </Link>
                    </h6>
