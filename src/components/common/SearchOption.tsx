...
//import images
import image2 from '@assets/img/users/avatar-2.jpg';
import image3 from '@assets/img/users/avatar-3.jpg';
import image5 from '@assets/img/users/avatar-5.jpg';
          ...
          <div className="notification-list">
            <Link href="#" className="dropdown-item notify-item py-2">
              <div className="d-flex">
                <Image src={image2.src} width={0} height={0} className="me-3 rounded-circle avatar-xs" alt="user-pic" />
            ...
            <Link href="#" className="dropdown-item notify-item py-2">
              <div className="d-flex">
                <Image src={image3.src} width={0} height={0} className="me-3 rounded-circle avatar-xs" alt="user-pic" />
                <div className="flex-1">
            ...
            <Link href="#" className="dropdown-item notify-item py-2">
              <div className="d-flex">
                <Image src={image5.src} width={0} height={0} className="me-3 rounded-circle avatar-xs" alt="user-pic" />
                <div className="flex-1">
