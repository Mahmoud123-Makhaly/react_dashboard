  ...
  extraReducers: builder => {
    ...
    builder.addCase(updateLead.fulfilled, (state: any, action: any) => {
      state.leads = state.leads.map(lead =>
        lead._id.toString() === action.payload.data._id.toString() ? { ...lead, ...action.payload.data } : lead,
      );
    ...
    builder.addCase(deleteLead.fulfilled, (state: any, action: any) => {
      state.leads = state.leads.filter(lead => lead._id.toString() !== action.payload.leads.toString());
