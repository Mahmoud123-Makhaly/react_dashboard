...
import btcCoin from '@assets/img/svg/crypto-icons/btc.svg';
import ltcCoin from '@assets/img/svg/crypto-icons/ltc.svg';
import etcCoin from '@assets/img/svg/crypto-icons/etc.svg';
import dashCoin from '@assets/img/svg/crypto-icons/dash.svg';
import bnbCoin from '@assets/img/svg/crypto-icons/bnb.svg';
import usdtCoin from '@assets/img/svg/crypto-icons/usdt.svg';
const topartWork = [
  {
    id: 1,
    img: Img1,
